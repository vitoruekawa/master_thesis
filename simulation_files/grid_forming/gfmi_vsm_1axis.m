classdef gfmi_vsm_1axis < component
    ...
    methods
        ...
        function [dx, con] = get_dx_constraint(obj, t, x, V, I, u)
            ...
            vdq_hat = obj.vsm.calculate_vdq_hat(idq, Eq, obj.vsc.L_g, omega);
            ...
            [d_delta, d_domega, d_Eq] = obj.vsm.get_dx(P, Pmech, Vfd, domega, Eq, idq);
        ...
        function set_equilibrium(obj, V, I)
            ...
            [delta_st, domega_st, Eq_st, Vfd] = obj.vsm.get_equilibrium(P, Q, V, I);
