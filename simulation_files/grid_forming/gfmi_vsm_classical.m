classdef gfmi_vsm_classical < component
    ...
    methods
        ...
        function obj = gfmi_vsm_classical(vsc_params, controller_params, vsm_params)
            obj.vsc = vsc(vsc_params);
            obj.vsc_controller = vsc_controller(controller_params);
            obj.vsm = vsm_classical(vsm_params);
            obj.avr = avr();
            obj.pss = pss();
        ...
        function [dx, con] = get_dx_constraint(obj, t, x, V, I, u)
            ...
            x_avr = x(10 + (1:nx_avr));
            x_pss = x(10 + nx_avr + (1:nx_pss));
            x_gov = x(10 + nx_avr + nx_pss + (1:nx_gov));
            ...
            vdq_hat = obj.vsm.calculate_vdq_hat(idq, obj.vsc.L_g, omega, x_avr(1));
            ...
            [dx_avr, ~] = obj.avr.get_Vfd(x_avr, norm(V), u(1) - v);
            [dx_gov, Pmech] = obj.governor.get_P(x_gov, domega, u(2));
            [d_delta, d_domega] = obj.vsm.get_dx(P, Pmech, domega);

            dx = [d_isdq; d_vdq; d_x_vdq; d_x_idq; d_delta; d_domega; dx_avr; dx_pss; dx_gov];
        ...
        function set_equilibrium(obj, V, I)
            ...
            [delta_st, domega_st] = obj.vsm.get_equilibrium(P, Q, V, I);
            ...
            obj.x_equilibrium = [isdq_st; vdq_st; x_vdq_st; x_idq_st; delta_st; domega_st; x_avr_st; x_pss_st; x_gov_st];
            obj.V_equilibrium = V;
            obj.I_equilibrium = I;
